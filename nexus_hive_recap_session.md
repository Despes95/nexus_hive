...
- [ ] **Sources en bas de réponse** — Badge cliquable "🔍 X Sources" sous la réponse du veilleur
  - Modifier `displaySources()` dans `renderer.js` pour injecter sous le dernier message assistant au lieu de la sidebar
  - CSS dans `index.html` pour le badge + liste dépliable
  - **Fichiers nécessaires** : `renderer.js`, `index.html`

- [ ] **Sélecteur Auto/Agent/Pipeline** — Menu déroulant à côté de l'input
  ...
  - **Fichiers nécessaires** : `renderer.js`, `index.html`, `preload.js`, `main.js`, `main.py`

- [ ] **Bouton "+" amélioré** — Remplacer le trombone `📎` par un `+` avec sous-menu
  - **Fichiers nécessaires** : `renderer.js`, `index.html`

- [ ] **Croix suppression conversations** — Détails dans la section bugs
  - **Fichiers nécessaires** : `renderer.js`, `main.py`, `main.js`

- [ ] **Correction bugs frontend rapides** — Badge agent idle, GPU auto-refresh
...
- [ ] **Test comparatif magnus vs Hermes 3** pour l'écrivain (creative writing + permissivité)
...
- [ ] **Harmoniser version → v1.0** — Mettre à jour : `package.json`, `__init__.py`, `preload.js`, `index.html`, `main.js`
